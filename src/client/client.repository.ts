...
export class ClientRepository extends Repository<Client> {
    ...
    async updateClient(createClientDto: CreateClientDto): Promise<boolean> {
        const {cli_ci, cli_firstName, cli_lastName, cli_phone, cli_debt, cli_isActive} = createClientDto;
        ...
        try {
            ...
            throw new BadRequestException({message: 'Error while trying to update user'});
        }
    }
}